...
namespace MyReadBooks.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            string folder_path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            string full_path = Path.Combine(folder_path, db_name);

            LoadApplication(new App(full_path, new AndroidInitializer()));
        }
